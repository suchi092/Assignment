...
<?php
$id=$_GET['news_id'];
$que="SELECT * FROM `tbl_news` WHERE `news_id`='$id'";
...
$query = "UPDATE `tbl_news` SET `title`='$title',`desc`='$desc',`date`='$date',`time`='$time' WHERE `news_id`='$id' ";
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <form action="" method='post'>
                                                    ...
                                                    <div class="form-group">
                                                        <label>Timing</label>
                                                        <input type="text" name="time" class="form-control"  value="<?= $row1['time'] ?>" data-toggle="input-mask" >
