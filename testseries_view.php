                            ...
                            <div class="card-box">
                                ...
                                <table id="example1" class="table" data-page-size="7">
                                    ...
                                    <tbody>
                                        <?php
                                        $i = 1;
                                        $fetch = mysqli_query($con, "SELECT * FROM `tbl_test_series`  ");
                                        while ($row_cat = mysqli_fetch_array($fetch)) {
                                            echo '
                                    <tr>
                                   
                                    <td>' . $row_cat['name1'] . '</td>
                                    <td><a href="upload_files/' . $row_cat['pdf'] . '" style="width:100px;" target="_blank">view pdf</a> </td>
                                    <td class="text-center"><a href="testseries_edit.php?test_series_id=' . $row_cat['test_series_id'] . '"   >
                                    <button class="demo-delete-row btn btn-success btn-xs btn-icon">Edit</button> </a></td>
                                    <td class="text-center"><a href="testseries_delete.php?test_series_id=' . $row_cat['test_series_id'] . '"   >
