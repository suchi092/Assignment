                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <table  id="example1" class="table" data-page-size="7">
                                        ...
                                        <tr>
                                            ...
                                            <th data-hide="phone, tablet">Cources</th>
                                ...
                                <?php
                                $i = 1;
                                $fetch = mysqli_query($con, "SELECT * FROM `tbl_query`  ");
                                while ($row_cat = mysqli_fetch_array($fetch)) {
                                    ...
                                    <td>' . $row_cat['phone'] . '</td>
                                    <td>' . $row_cat['email'] . '</td>
                                    <td>' . $row_cat['cources'] . '</td>
                                    <td class="text-center"><a href="query_delete.php?query_id=' . $row_cat['query_id'] . '"   >
