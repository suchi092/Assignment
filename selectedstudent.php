...
$rt = "INSERT INTO `tbl_selected`(  `name1`,`image`,`tag`) VALUES ('" . $name1 . "','" . $image. "','" . $tag. "') ";
// echo $rt;
$result = mysqli_query($con, $rt);
if ($result) {
    echo '<script>alert("Selected Student saved successfully")</script>';
    echo '<script>window.location="selectedstudent_view.php"</script>';
} else {
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Selected Students</a></li>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <form action="" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Tag</label>
                                                        <input type="text"  name="tag" class="form-control" data-toggle="input-mask" >
