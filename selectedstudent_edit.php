...
<?php
$id=$_GET['selected_id'];
$que="SELECT * FROM `tbl_selected` WHERE `selected_id`='$id'";
...
$query = "UPDATE `tbl_selected` SET `name1`='$name1', `image`='$image', `tag`='$tag'   WHERE `selected_id` = '$id' ";
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);"> Edit selected student</a></li>
                                           
                                        </ol>
                                    </div>
                                    <h4 class="page-title">selected student</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <div class="row">
                                            ...
                                            <form action="" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <span class="font-13 text-muted">e.g "image file"</span>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Tag</label>
                                                        <input type="text"  name="tag" class="form-control" value="<?= $row1['tag'] ?>" data-toggle="input-mask" >
                                                        <span class="font-13 text-muted">e.g "tag"</span>
                                                    </div>
