                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Selected Student</a></li>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?php
                                $i = 1;
                                $fetch = mysqli_query($con, "SELECT * FROM `tbl_selected`  ");
                                while ($row_cat = mysqli_fetch_array($fetch)) {
                                    ...
                                    <td>' . $row_cat['tag'] . '</td>
                                    <td class="text-center"><a href="selectedstudent_edit.php?selected_id=' . $row_cat['selected_id'] . '"   >
                                    <button class="demo-delete-row btn btn-success btn-xs btn-icon">Edit</button> </a></td>
                                    <td class="text-center"><a href="selectedstudent_delete.php?selected_id=' . $row_cat['selected_id'] . '"   >
