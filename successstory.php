...
$rt = "INSERT INTO `tbl_story`(`name1`,`image`,`designation`,`testimonial`) VALUES ('" . $name1 . "','" . $image. "','" . $designation. "','" . $testimonial. "') ";
// echo $rt;
$result = mysqli_query($con, $rt);
if ($result) {
    echo '<script>alert("Success Story saved successfully")</script>';
    echo '<script>window.location="successstory_view.php"</script>';
} else {
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Success Story</a></li>
                                        ...
                                        <div class="row">
                                            ...
                                            <form action="" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"  name="designation" class="form-control" data-toggle="input-mask" >
                                                        <span class="font-13 text-muted">e.g "designation"</span>
                                                    </div> 
                                                    <div class="form-group">
                                                        <label>Testimonial</label>
                                                        <input type="text" name="testimonial" class="form-control" data-toggle="input-mask" >
