...
$que="SELECT * FROM `tbl_test_series` WHERE `test_series_id`='$id'";
...
$query = "UPDATE `tbl_test_series` SET `name1`='$name1', `pdf`='$pdf' WHERE `test_series_id` = '$id' ";
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">CD Campus</a></li>
                                            <li class="breadcrumb-item"><a href="javascript: void(0);"> Edit Testseries</a></li>
                                           
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Testseries</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <form action="" method="post" enctype="multipart/form-data" >
                                                    ...
                                                    <div class="form-group">
                                                        <label>pdf</label>
                                                        <input type="file" name="pdf" class="form-control" value="<?= $row1['pdf'] ?>"  id="fileToUpload">
