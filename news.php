...
$date = $_POST['date'];
$time = $_POST['time'];
$rt = "INSERT INTO `tbl_news`(  `title`,`desc`,`date`,`time`) VALUES ('" . $title . "','" . $desc . "','" . $date . "','" . $time . "') ";
// echo $rt;
$result = mysqli_query($con, $rt);
if ($result) {
    echo '<script>alert("News saved successfully")</script>';
    echo '<script>window.location="news_view.php"</script>';
} else {
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">News Update</a></li>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <form action="" method='post'>
                                                    ...
                                                    <div class="form-group">
                                                        <label>Date</label>
                                                        <input type="text" name="date"class="form-control" data-toggle="input-mask" >
                                                        <span class="font-13 text-muted">e.g "DD/MM/YYYY"</span>
                                                    </div>
                                                     
                                                    <div class="form-group">
                                                        <label>Timing</label>
                                                        <input type="text" name="time" class="form-control" data-toggle="input-mask" >
