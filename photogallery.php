...
$rt = "INSERT INTO `tbl_gallery`(  `name1`,`image`) VALUES ('" . $name1 . "','" . $image. "') ";
// echo $rt;
$result = mysqli_query($con, $rt);
if ($result) {
    echo '<script>alert("Photo/Gallery saved successfully")</script>';
    echo '<script>window.location="photogallery_view.php"</script>';
} else {
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <form action="" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Images</label>
                                                        <input type="file" name="newimage" class="form-control" id="fileToUpload">

                                                        <span class="font-13 text-muted">e.g "image"</span>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Images</label>
                                                        <input type="text" name="image" class="form-control" id="fileToUpload">
