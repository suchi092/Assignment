                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <table  id="example1" class="table" data-page-size="7">
                                        ...
                                        <tr>
                                            ...
                                            <th data-sort-initial="true" data-toggle="true">Images</th>
                                ...
                                <?php
                                $i = 1;
                                $fetch = mysqli_query($con, "SELECT * FROM `tbl_gallery`  ");
                                while ($row_cat = mysqli_fetch_array($fetch)) {
                                    ...
                                    <td class="text-center"><a href="photogallery_edit.php?gallery_id=' . $row_cat['gallery_id'] . '"   >
                                    <button class="demo-delete-row btn btn-success btn-xs btn-icon">Edit</button> </a></td>
                                    <td class="text-center"><a href="photogallery_delete.php?gallery_id=' . $row_cat['gallery_id'] . '"   >
                                    <button class="demo-delete-row btn btn-danger btn-xs btn-icon"></i>Delete</button> </a></td>
