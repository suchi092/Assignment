                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?php
                                $i = 1;
                                $fetch = mysqli_query($con, "SELECT * FROM `tbl_news`  ");
                                while ($row_cat = mysqli_fetch_array($fetch)) {
                                    ...
                                    <td>' . $row_cat['date'] . '</td>
                                    <td>' . $row_cat['time'] . '</td>
                                    <td class="text-center"><a href="news_edit.php?news_id=' . $row_cat['news_id'] . '"   >
                                    <button class="demo-delete-row btn btn-success btn-xs btn-icon">Edit</button> </a></td>
                                    <td class="text-center"><a href="news_delete.php?news_id=' . $row_cat['news_id'] . '"   >
