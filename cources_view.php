                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Cources</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?php
                                $i = 1;
                                $fetch = mysqli_query($con, "SELECT * FROM `tbl_cources`  ");
                                while ($row_cat = mysqli_fetch_array($fetch)) {
                                    ...
                                    <td class="text-center"><a href="cources_edit.php?cources_id=' . $row_cat['cources_id'] . '"   >
                                    <button class="demo-delete-row btn btn-success btn-xs btn-icon">Edit</button> </a></td>
                                    <td class="text-center"><a href="cources_delete.php?cources_id=' . $row_cat['cources_id'] . '"   >
