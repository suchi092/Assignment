                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <table  id="example1" class="table" data-page-size="7">
                                        ...
                                        <tr>
                                            ...
                                            <th data-hide="phone, tablet">Courses</th>
                                ...
                                while ($row_cat = mysqli_fetch_array($fetch)) {
                                    ...
                                    <td>' . $row_cat['date'] . '</td>
                                    <td>' . $row_cat['time'] . '</td>
                                    <td>' . $row_cat['courses'] . '</td>

                                    <td class="text-center"><a href="upcomingbatch_edit.php?batche_id=' . $row_cat['batche_id'] . '"   >
                                    <button class="demo-delete-row btn btn-success btn-xs btn-icon">Edit</button> </a></td>
                                    <td class="text-center"><a href="upcoming_delete.php?batche_id=' . $row_cat['batche_id'] . '"   >
