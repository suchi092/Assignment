...
$rt = "INSERT INTO `tbl_upcoming_batches`(  `title`,`desc`,`date`,`time`,`courses`) VALUES ('" . $title . "','" . $desc . "','" . $date . "','" . $time . "','" . $courses . "') ";
// echo $rt;
$result = mysqli_query($con, $rt);
if ($result) {
    echo '<script>alert("Upcoming Batches saved successfully")</script>';
    echo '<script>window.location="upcomingbatch_view.php"</script>';
} else {
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Upcoming Batches</a></li>
                                            ...
                                            <div class="col-md-6">
                                                <form action="" method='post'>
                                                    ...
                                                    <div class="form-group">
                                                        <label>Title</label>
                                                        <input type="text"  name="title" class="form-control" data-toggle="input-mask" >
                                                        <span class="font-13 text-muted">e.g "title_name"</span>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Description</label>
                                                        <input type="textarea" name="desc" class="form-control" data-toggle="input-mask" >
                                                        <span class="font-13 text-muted">e.g "Description"</span>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Date</label>
                                                        <input type="Date" name="date" class="form-control" data-toggle="input-mask" >
                                                        <span class="font-13 text-muted">e.g "DD/MM/YYYY"</span>
                                                    </div>
                                                     
                                                    <div class="form-group">
                                                        <label>Timing</label>
                                                        <input type="Time" name="time" class="form-control" data-toggle="input-mask" >
                                                        <span class="font-13 text-muted">e.g "HH:MM:SS"</span>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Courses</label>
                                                        <input type="text" name="courses" class="form-control" data-toggle="input-mask" >
