...
<?php
$id=$_GET['cources_id'];
$que="SELECT * FROM `tbl_cources` WHERE `cources_id`='$id'";
...
$query = "UPDATE `tbl_cources` SET `name1`='$name1', `image`='$image' WHERE `cources_id` = '$id' ";
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Edit Cources</a></li>
                                           
                                        </ol>
                                    </div>
                                    <h4 class="page-title"> Edit Cources</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <div class="row">
                                            ...
                                            <form action="" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        <label>name</label>
                                                        <input type="text"  name="name1" class="form-control" value="<?= $row1['name1'] ?>"
