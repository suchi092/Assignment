...
<?php
$id=$_GET['story_id'];
$que="SELECT * FROM `tbl_story` WHERE `story_id`='$id'";
...
if (isset($_POST['submit']))
{
    ...
    move_uploaded_file($_FILES['image']['tmp_name'],'uploaded_images/'.$image);

$query = "UPDATE `tbl_story` SET `name1`='$name1', `image`='$image' ,`designation`='$designation' , `testimonial`='$testimonial' WHERE `story_id` = '$id' ";
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Edit Success Story</a></li>
                                           
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Success Story</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <form action="" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Images</label>
                                                        <input type="file" name="image" class="form-control" value="<?= $row1['image'] ?>" id="fileToUpload">
                                                        <span class="font-13 text-muted">e.g "image"</span>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>designation</label>
                                                        <input type="text"  name="designation" class="form-control" value="<?= $row1['designation'] ?>" data-toggle="input-mask" >
                                                        <span class="font-13 text-muted">e.g "designation"</span>
                                                    </div> 
                                                    <div class="form-group">
                                                        <label>Testimonial</label>
                                                        <input type="text" name="testimonial" class="form-control"  value="<?= $row1['testimonial'] ?>" data-toggle="input-mask" >
                                                        <span class="font-13 text-muted">e.g "testimonial"</span>
                                                    </div>
                                                    <div class="form-group">                                                      
