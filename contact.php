                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?php
                                $i = 1;
                                $fetch = mysqli_query($con, "SELECT * FROM `tbl_contact_us`  ");
                                while ($row_cat = mysqli_fetch_array($fetch)) {
                                    ...
                                    <td>' . $row_cat['message'] . '</td>
                                    <td class="text-center"><a href="contact_delete.php?contact_id=' . $row_cat['contact_id'] . '"   >
...
<!-- Mirrored from coderthemes.com/ubold/layouts/purple/tables-footables.html by HTTr                                                                                              vbbnnnnnn                               bn                                                                                     ack Website Copier/3.x [XR&CO'2014], Sat, 29 Feb 2020 06:38:13 GMT -->
</html>