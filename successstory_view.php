                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <table  id="example1" class="table" data-page-size="7">
                                        ...
                                        <tr>
                                            ...
                                            <th data-hide="phone, tablet">Testimonial</th>
                                            <th data-sort-ignore="true" class="min-width">Edit</th>
                                ...
                                <?php
                                $i = 1;
                                $fetch = mysqli_query($con, "SELECT * FROM `tbl_story`  ");
                                while ($row_cat = mysqli_fetch_array($fetch)) {
                                    echo '
                                    <tr>
                                    
                                    <td>' . $row_cat['name1'] . '</td>
                                    <td><img src="uploaded_images/' .$row_cat['image'] . '" style="width:100px;"/>  
                                    </td>
                                    <td>' . $row_cat['designation'] . '</td>
                                    <td>' . $row_cat['testimonial'] . '</td>
                                    <td class="text-center"><a href="successstory_edit.php?story_id=' . $row_cat['story_id'] . '"   >
                                    <button class="demo-delete-row btn btn-success btn-xs btn-icon">Edit</a></td>
                                    <td class="text-center"><a href="successstory_delete.php?story_id=' . $row_cat['story_id'] . '"   >
